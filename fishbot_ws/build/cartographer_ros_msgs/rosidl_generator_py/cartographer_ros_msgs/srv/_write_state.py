...
class WriteState_Request(metaclass=Metaclass_WriteState_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.include_unfinished_submaps = kwargs.get('include_unfinished_submaps', bool())
    ...
    def __eq__(self, other):
        ...
        if self.filename != other.filename:
            return False
        if self.include_unfinished_submaps != other.include_unfinished_submaps:
            return False
        return True
    ...
    @builtins.property
    def include_unfinished_submaps(self):
        """Message field 'include_unfinished_submaps'."""
        return self._include_unfinished_submaps

    @include_unfinished_submaps.setter
    def include_unfinished_submaps(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'include_unfinished_submaps' field must be of type 'bool'"
        self._include_unfinished_submaps = value
