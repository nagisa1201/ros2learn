...
bool cartographer_ros_msgs__msg__metric_label__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartographer_ros_msgs.msg._metric_label.MetricLabel", full_classname_dest, 51) == 0);
  }
  cartographer_ros_msgs__msg__MetricLabel * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of MetricLabel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartographer_ros_msgs.msg._metric_label");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MetricLabel");
