...
static size_t _FinishTrajectory_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartographer_ros_msgs__srv__FinishTrajectory_Request(
...
static size_t _FinishTrajectory_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartographer_ros_msgs__srv__FinishTrajectory_Response(
    full_bounded, is_plain, 0);
