...
#include "cartographer_ros_msgs/msg/detail/submap_entry__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cartographer_ros_msgs::msg::SubmapEntry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cartographer_ros_msgs::msg::SubmapEntry & ros_message)
{
  // Member: trajectory_id
  cdr >> ros_message.trajectory_id;
  ...
  // Member: is_frozen
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.is_frozen = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartographer_ros_msgs::msg::SubmapEntry;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cartographer_ros_msgs::msg::SubmapEntry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cartographer_ros_msgs::msg::SubmapEntry *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SubmapEntry__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cartographer_ros_msgs::msg::SubmapEntry *>(
...
static size_t _SubmapEntry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SubmapEntry(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SubmapEntry__callbacks = {
...
static rosidl_message_type_support_t _SubmapEntry__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SubmapEntry__callbacks,
...
{
  return &cartographer_ros_msgs::msg::typesupport_fastrtps_cpp::_SubmapEntry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartographer_ros_msgs, msg, SubmapEntry)() {
  return &cartographer_ros_msgs::msg::typesupport_fastrtps_cpp::_SubmapEntry__handle;
}
