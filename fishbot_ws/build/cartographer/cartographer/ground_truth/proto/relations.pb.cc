...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto = {
  false, false, descriptor_table_protodef_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto, "cartographer/ground_truth/proto/relations.proto", 348,
...
static bool dynamic_init_dummy_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto)), true);
namespace cartographer {
namespace ground_truth {
namespace proto {
...
void Relation::clear_expected() {
  if (GetArena() == nullptr && expected_ != nullptr) {
    delete expected_;
  }
  expected_ = nullptr;
}
