...
class PoseGraph_Constraint PROTOBUF_FINAL :
...
class PoseGraph_LandmarkPose PROTOBUF_FINAL :
 ...
 public:
  ...
  "    future release.")
  std::string* unsafe_arena_release_landmark_id();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_landmark_id(
...
class PoseGraph PROTOBUF_FINAL :
...
inline void PoseGraph_Constraint::clear_submap_id() {
  if (GetArena() == nullptr && submap_id_ != nullptr) {
    delete submap_id_;
  }
  submap_id_ = nullptr;
}
...
inline void PoseGraph_Constraint::set_allocated_submap_id(::cartographer::mapping::proto::SubmapId* submap_id) {
  ...
  if (submap_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(submap_id);
...
inline void PoseGraph_LandmarkPose::clear_landmark_id() {
  landmark_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void PoseGraph_LandmarkPose::_internal_set_landmark_id(const std::string& value) {
  ...
  landmark_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void PoseGraph_LandmarkPose::set_landmark_id(const char* value) {
  ...
  landmark_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void PoseGraph_LandmarkPose::set_landmark_id(const char* value,
  ...
  landmark_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* PoseGraph_LandmarkPose::_internal_mutable_landmark_id() {
  ...
  return landmark_id_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* PoseGraph_LandmarkPose::release_landmark_id() {
  ...
  return landmark_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* PoseGraph_LandmarkPose::unsafe_arena_release_landmark_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:cartographer.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return landmark_id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void PoseGraph_LandmarkPose::unsafe_arena_set_allocated_landmark_id(
    std::string* landmark_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (landmark_id != nullptr) {
  ...
  landmark_id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      landmark_id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
...
inline void PoseGraph_LandmarkPose::set_allocated_global_pose(::cartographer::transform::proto::Rigid3d* global_pose) {
  ...
  if (global_pose) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(global_pose)->GetArena();
    if (message_arena != submessage_arena) {
