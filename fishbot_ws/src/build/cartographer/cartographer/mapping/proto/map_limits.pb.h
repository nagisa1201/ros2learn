...
class MapLimits PROTOBUF_FINAL :
...
inline ::cartographer::mapping::proto::CellLimits* MapLimits::release_cell_limits() {
  auto temp = unsafe_arena_release_cell_limits();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::cartographer::mapping::proto::CellLimits* MapLimits::_internal_mutable_cell_limits() {
  ...
  if (cell_limits_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::CellLimits>(GetArena());
    cell_limits_ = p;
  }
  return cell_limits_;
}
...
inline void MapLimits::set_allocated_cell_limits(::cartographer::mapping::proto::CellLimits* cell_limits) {
  ...
  if (cell_limits) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(cell_limits)->GetArena();
    if (message_arena != submessage_arena) {
