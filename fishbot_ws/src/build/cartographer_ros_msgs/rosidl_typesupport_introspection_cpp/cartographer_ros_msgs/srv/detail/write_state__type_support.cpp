...
void WriteState_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cartographer_ros_msgs::srv::WriteState_Request(_init);
}

void WriteState_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cartographer_ros_msgs::srv::WriteState_Request *>(message_memory);
  typed_message->~WriteState_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember WriteState_Request_message_member_array[2] = {
  {
    "filename",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartographer_ros_msgs::srv::WriteState_Request, include_unfinished_submaps),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WriteState_Request_message_members = {
  ...
  WriteState_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  WriteState_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void WriteState_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cartographer_ros_msgs::srv::WriteState_Response(_init);
}

void WriteState_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cartographer_ros_msgs::srv::WriteState_Response *>(message_memory);
  typed_message->~WriteState_Response();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WriteState_Response_message_members = {
  ...
  WriteState_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  WriteState_Response_fini_function  // function to terminate message instance (will not free memory)
};
