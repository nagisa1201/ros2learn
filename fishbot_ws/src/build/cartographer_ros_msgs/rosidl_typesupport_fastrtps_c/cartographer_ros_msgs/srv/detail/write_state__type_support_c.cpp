  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: include_unfinished_submaps
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartographer_ros_msgs__srv__WriteState_Request;
    is_plain =
      (
...
static size_t _WriteState_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartographer_ros_msgs__srv__WriteState_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cartographer_ros_msgs__srv__WriteState_Response;
    is_plain =
      (
...
static size_t _WriteState_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartographer_ros_msgs__srv__WriteState_Response(
    full_bounded, is_plain, 0);
