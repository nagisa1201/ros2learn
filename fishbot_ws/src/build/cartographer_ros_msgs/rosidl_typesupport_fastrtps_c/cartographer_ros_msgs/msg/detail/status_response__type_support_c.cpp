  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartographer_ros_msgs__msg__StatusResponse;
    is_plain =
      (
...
static size_t _StatusResponse__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cartographer_ros_msgs__msg__StatusResponse(
