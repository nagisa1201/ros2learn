...
struct SubmapList_
{
  ...
  _header_type header;
  using _submap_type =
    std::vector<cartographer_ros_msgs::msg::SubmapEntry_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<cartographer_ros_msgs::msg::SubmapEntry_<ContainerAllocator>>>;
  _submap_type submap;
  ...
  Type & set__submap(
    const std::vector<cartographer_ros_msgs::msg::SubmapEntry_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<cartographer_ros_msgs::msg::SubmapEntry_<ContainerAllocator>>> & _arg)
  {
    this->submap = _arg;
    return *this;
  }
