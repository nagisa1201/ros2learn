...
struct WriteState_Request_
{
  ...
  using _include_unfinished_submaps_type =
    bool;
  ...
  Type & set__include_unfinished_submaps(
    const bool & _arg)
  {
    this->include_unfinished_submaps = _arg;
    return *this;
  }
  ...
  bool operator==(const WriteState_Request_ & other) const
  {
    ...
    if (this->include_unfinished_submaps != other.include_unfinished_submaps) {
      return false;
    }
    return true;
  }
