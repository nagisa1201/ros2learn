...
#include "cartographer_ros_msgs/msg/detail/landmark_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartographer_ros_msgs::msg::LandmarkList;
    is_plain =
      (
...
static size_t _LandmarkList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LandmarkList(full_bounded, is_plain, 0);
