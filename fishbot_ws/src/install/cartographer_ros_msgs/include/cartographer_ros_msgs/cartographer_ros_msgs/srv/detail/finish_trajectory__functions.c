...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Request__are_equal(const cartographer_ros_msgs__srv__FinishTrajectory_Request * lhs, const cartographer_ros_msgs__srv__FinishTrajectory_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Request__copy(
  const cartographer_ros_msgs__srv__FinishTrajectory_Request * input,
  cartographer_ros_msgs__srv__FinishTrajectory_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
cartographer_ros_msgs__srv__FinishTrajectory_Request__create()
{
  ...
  cartographer_ros_msgs__srv__FinishTrajectory_Request * msg = (cartographer_ros_msgs__srv__FinishTrajectory_Request *)allocator.allocate(sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence__init(cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__srv__FinishTrajectory_Request *)allocator.zero_allocate(size, sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * array = (cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence *)allocator.allocate(sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence__are_equal(const cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * lhs, const cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cartographer_ros_msgs__srv__FinishTrajectory_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence__copy(
  const cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * input,
  cartographer_ros_msgs__srv__FinishTrajectory_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cartographer_ros_msgs__srv__FinishTrajectory_Request * data =
      (cartographer_ros_msgs__srv__FinishTrajectory_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__FinishTrajectory_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__FinishTrajectory_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cartographer_ros_msgs__srv__FinishTrajectory_Request__copy(
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Response__are_equal(const cartographer_ros_msgs__srv__FinishTrajectory_Response * lhs, const cartographer_ros_msgs__srv__FinishTrajectory_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Response__copy(
  const cartographer_ros_msgs__srv__FinishTrajectory_Response * input,
  cartographer_ros_msgs__srv__FinishTrajectory_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cartographer_ros_msgs__srv__FinishTrajectory_Response * msg = (cartographer_ros_msgs__srv__FinishTrajectory_Response *)allocator.allocate(sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence__init(cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__srv__FinishTrajectory_Response *)allocator.zero_allocate(size, sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * array = (cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence *)allocator.allocate(sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence__are_equal(const cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * lhs, const cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cartographer_ros_msgs__srv__FinishTrajectory_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence__copy(
  const cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * input,
  cartographer_ros_msgs__srv__FinishTrajectory_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cartographer_ros_msgs__srv__FinishTrajectory_Response * data =
      (cartographer_ros_msgs__srv__FinishTrajectory_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__FinishTrajectory_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__FinishTrajectory_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!cartographer_ros_msgs__srv__FinishTrajectory_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
