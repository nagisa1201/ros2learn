...
void fetch_function__SubmapList__submap(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const cartographer_ros_msgs::msg::SubmapEntry *>(
    get_const_function__SubmapList__submap(untyped_member, index));
  auto & value = *reinterpret_cast<cartographer_ros_msgs::msg::SubmapEntry *>(untyped_value);
  value = item;
}

void assign_function__SubmapList__submap(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<cartographer_ros_msgs::msg::SubmapEntry *>(
    get_function__SubmapList__submap(untyped_member, index));
  const auto & value = *reinterpret_cast<const cartographer_ros_msgs::msg::SubmapEntry *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SubmapList_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__SubmapList__submap,  // fetch(index, &value) function pointer
    assign_function__SubmapList__submap,  // assign(index, value) function pointer
