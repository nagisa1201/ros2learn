...
void cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_init_function(
...
void cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_fini_function(void * message_memory)
{
  cartographer_ros_msgs__msg__SubmapEntry__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_member_array[5] = {
  {
    "trajectory_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartographer_ros_msgs__msg__SubmapEntry, is_frozen),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_members = {
...
static rosidl_message_type_support_t cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, msg, SubmapEntry)() {
  cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
  if (!cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_type_support_handle.typesupport_identifier) {
    cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &cartographer_ros_msgs__msg__SubmapEntry__rosidl_typesupport_introspection_c__SubmapEntry_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
