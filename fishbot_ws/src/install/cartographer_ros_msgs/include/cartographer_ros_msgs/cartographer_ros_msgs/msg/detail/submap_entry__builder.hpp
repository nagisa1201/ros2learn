...
class Init_SubmapEntry_is_frozen
{
public:
  explicit Init_SubmapEntry_is_frozen(::cartographer_ros_msgs::msg::SubmapEntry & msg)
  : msg_(msg)
  {}
  ::cartographer_ros_msgs::msg::SubmapEntry is_frozen(::cartographer_ros_msgs::msg::SubmapEntry::_is_frozen_type arg)
  {
    msg_.is_frozen = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SubmapEntry_is_frozen pose(::cartographer_ros_msgs::msg::SubmapEntry::_pose_type arg)
  {
    msg_.pose = std::move(arg);
    return Init_SubmapEntry_is_frozen(msg_);
  }
