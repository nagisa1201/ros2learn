...
class RangefinderPoint PROTOBUF_FINAL :
...
class TimedRangefinderPoint PROTOBUF_FINAL :
...
class CompressedPointCloud PROTOBUF_FINAL :
...
class TimedPointCloudData PROTOBUF_FINAL :
...
class RangeData PROTOBUF_FINAL :
...
class LandmarkData_LandmarkObservation PROTOBUF_FINAL :
...
inline ::cartographer::transform::proto::Vector3f* RangefinderPoint::_internal_mutable_position() {
  ...
  if (position_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::transform::proto::Vector3f>(GetArena());
    position_ = p;
  }
  return position_;
}
...
inline ::cartographer::transform::proto::Vector3d* ImuData::_internal_mutable_linear_acceleration() {
  ...
  if (linear_acceleration_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::transform::proto::Vector3d>(GetArena());
...
inline void LandmarkData_LandmarkObservation::set_id(const void* value,
    size_t size) {
...
inline std::string* LandmarkData_LandmarkObservation::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:cartographer.sensor.proto.LandmarkData.LandmarkObservation.id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LandmarkData_LandmarkObservation::unsafe_arena_set_allocated_id(
    std::string* id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (id != nullptr) {
  ...
  id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.sensor.proto.LandmarkData.LandmarkObservation.id)
}
...
inline ::cartographer::transform::proto::Rigid3d* LandmarkData_LandmarkObservation::release_landmark_to_tracking_transform() {
  auto temp = unsafe_arena_release_landmark_to_tracking_transform();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline void LandmarkData_LandmarkObservation::set_allocated_landmark_to_tracking_transform(::cartographer::transform::proto::Rigid3d* landmark_to_tracking_transform) {
  ...
  if (landmark_to_tracking_transform) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(landmark_to_tracking_transform)->GetArena();
    if (message_arena != submessage_arena) {
