...
bool cartographer_ros_msgs__msg__status_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartographer_ros_msgs.msg._status_response.StatusResponse", full_classname_dest, 57) == 0);
  }
  cartographer_ros_msgs__msg__StatusResponse * ros_message = _ros_message;
  {  // code
...
{
  /* NOTE(esteve): Call constructor of StatusResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartographer_ros_msgs.msg._status_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StatusResponse");
