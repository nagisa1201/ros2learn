...
void cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_init_function(
...
void cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_fini_function(void * message_memory)
{
  cartographer_ros_msgs__msg__HistogramBucket__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_member_array[2] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_members = {
...
static rosidl_message_type_support_t cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, msg, HistogramBucket)() {
  if (!cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_type_support_handle.typesupport_identifier) {
    cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &cartographer_ros_msgs__msg__HistogramBucket__rosidl_typesupport_introspection_c__HistogramBucket_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
